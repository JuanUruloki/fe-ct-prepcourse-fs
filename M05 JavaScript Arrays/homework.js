...
function devolverPrimerElemento(array) {
   ...
   // Tu código:
   return devolverPrimerElemento = array[0];
}

function devolverUltimoElemento(array) {
   // Retornar el último elemento del arreglo recibido por parámetro.
   // Tu código:
   return devolverUltimoElemento = (array[array.length - 1]);
}

function obtenerLargoDelArray(array) {
   // Retornar la longitud del arreglo recibido por parámetro.
   // Tu código:
   return obtenerLargoDelArray = array.length;
}
...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var valorInicial = 0; 
   var agregarNumeros = arrayOfNums.reduce((accumulator, currentValue) => accumulator + currentValue,
   valorInicial);
...
function cuentoElementos(array) {
   ...
   // Tu código:
   mayorADieciocho = array.filter(num => num > 18 );
...
function mesesDelAño(array) {
   ...
   const encontrados = mesesPedidos.filter((value) => array.includes(value));

   if (encontrados.length === mesesPedidos.length) return encontrados;
